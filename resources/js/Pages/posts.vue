    ...
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Administrar Post - (Laravel 8 Inertia JS CRUD con Jetstream y Tailwind CSS - gvaldovi.com)                                                             
            </h2>
        </template>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                    ...
                    <button @click="openModal()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-3">Crear Nuevo Post</button>
                        ...
                        <tbody>
                            <tr v-for="row in data" :key="row.id">
                                ...
                                <td class="border px-4 py-2">
                                    ...
                                    <button @click="deleteRow(row)" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Borrar</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                ...
                                <form>
                                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                        <div class="">
                                            ...
                                            <div class="mb-4">
                                                <label for="exampleFormControlInput2" class="block text-gray-700 text-sm font-bold mb-2">Cuerpo:</label>
...
<script>
    ...
    export default {
        ...
        //Este se pone si no utilizamos $page.props en el template
        //props: ['data','errors','flash'], 
        //Si no lo importamos como props
        props: ['data'],
        data() {
            return {
                editMode: false,
        ...
        methods: {
            ...
            deleteRow: function (data) {
                if (!confirm('Estás seguro que desae borrar?')) return;
                data._method = 'DELETE';
                this.$inertia.post('/posts/' + data.id, data)
                this.reset();
                this.closeModal();
